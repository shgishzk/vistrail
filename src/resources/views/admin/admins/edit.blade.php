    ...
    <div class="card-body">
        <form action="{{ route('admin.admins.update', $admin) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="form-text">@lang('Leave blank to keep current password. If changing: 6-20 characters and include uppercase, lowercase, and numbers.')</div>
                @error('password')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
