...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        $defaultSettings = [
            ...
            'GOOGLE_MARKER_HAS_LOCK_BACKGROUND' => env('GOOGLE_MARKER_HAS_LOCK_BACKGROUND', '#EA766C'),
            'GOOGLE_MARKER_HAS_LOCK_BORDER_COLOR' => env('GOOGLE_MARKER_HAS_LOCK_BORDER_COLOR', '#C81714'),
            'GOOGLE_MARKER_HAS_LOCK_GLYPH_COLOR' => env('GOOGLE_MARKER_HAS_LOCK_GLYPH_COLOR', '#C81714'),
            'GOOGLE_MARKER_NO_LOCK_BACKGROUND' => env('GOOGLE_MARKER_NO_LOCK_BACKGROUND', '#6AAF6C'),
            'GOOGLE_MARKER_NO_LOCK_BORDER_COLOR' => env('GOOGLE_MARKER_NO_LOCK_BORDER_COLOR', '#2D8F32'),
            'GOOGLE_MARKER_NO_LOCK_GLYPH_COLOR' => env('GOOGLE_MARKER_NO_LOCK_GLYPH_COLOR', '#2D8F32'),
