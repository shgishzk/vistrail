...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        $defaultSettings = [
            ...
            'GOOGLE_MARKER_HAS_LOCK_BACKGROUND' => env('GOOGLE_MARKER_HAS_LOCK_BACKGROUND', '#EA4335'),
            'GOOGLE_MARKER_HAS_LOCK_BORDER_COLOR' => env('GOOGLE_MARKER_HAS_LOCK_BORDER_COLOR', '#C5221F'),
            'GOOGLE_MARKER_HAS_LOCK_GLYPH_COLOR' => env('GOOGLE_MARKER_HAS_LOCK_GLYPH_COLOR', '#C5221F'),
